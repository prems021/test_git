...
@Component({
  selector: 'app-view-purchase-return-bills',
  templateUrl: './main.html',
  styleUrls: ['./main.scss']
})
export class View_Purchase_return_bills_Component implements OnInit {
  ...
  constructor(private api : ApiService,private formBuilder: FormBuilder, private rs: Router,
   ...
   ngOnInit(): void {
    ...
    this.columns = [
      ...
      { key: 'payable_amt', title: 'Amount' },
      { key: 'ref_invoice_number', title: 'Ref Invoice' },
  ...
  get_bills()
  {
    this.api.get_all_purchase_returns()
...
eventEmitted($event) {
  ...
  else
  {
             ...
             this.rs.navigate(['/home/update-purchase-return']);
