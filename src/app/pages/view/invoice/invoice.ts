...
export class Viewbills_InvoiceComponent implements OnInit {
...
eventEmitted($event) {
  ...
  if($event.event == 'onSearch' || $event.event == 'onPagination' || $event.event == 'onOrder' )
  {
