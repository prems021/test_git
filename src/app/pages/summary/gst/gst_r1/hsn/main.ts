...
@Component({
  selector: 'app-summary-sales-hsn-wise',
  templateUrl: './main.html',
  styleUrls: ['./main.scss'],
})
export class Summary_gst_hsn_wise_sales implements OnInit {
  ...
  generate()
  {
    ...
    if(this.sdate == null || this.edate == null)
    {
      alert('select date range properly')
        ...
        this.api.summary_sales_hsn_wise_stock(this.post_mo).subscribe((data:any) => {
          this.get_res_(data);
        });
    }    
